...
app.get("/", async (req, res2) => {
  ...
  const res = await api.sendMessage(
    "Can you list 50 types of websites in the world send in-app notifications? just the category"
  );
